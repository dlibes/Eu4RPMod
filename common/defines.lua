...
NEconomy = {
	...
	AUTONOMY_AT_DIPLO_ANNEX = 40,					-- Autonomy added when diplo-annexing
...
NAI = {
	...
	PEACE_TERMS_PILLAGE_CAPITAL_MULT = 0,
...
NReligion = {
	...
	YEARLY_PAPAL_INFLUENCE_CATHOLIC = 0.75,						-- The amount of yearly papal influence you receive each year for being catholic
...
NGovernment = {
	...
	GOVERNMENT_REFORM_YEARLY_BASE_PROGRESS = 12.0,
	...
	CONCENTRATE_DEVELOPMENT_OTHER_STATE_PROVINCES_PROPORTION = 0.1,
	FREE_CONCENTRATE_DEVELOPMENT_CAPITAL_PROPORTION = 0.4,
